<header id="main-section">
    <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-white main-nav">
        <a class="navbar-brand" href="#index.html">
            <img src="{{asset('tamkeen-proj/assets/imgs/logo.jpg')}}" alt="logo" width="20%"></a>
            ...
            <div class="form-inline mt-2 mt-md-0 mr-auto">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item @yield('profileActive')">
                        <a class="nav-link" href="{{asset('/member/profile')}}">{{trans('messages.welcome')}} {{auth()->user()->name}}</a>
                    </li>
                    <li class="nav-item @yield('profileActive')">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="route('logout')"
                                ...
                                class="nav-link">{{trans('messages.signout')}}</a>
